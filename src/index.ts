...
app.post("/users", async (req: Request, res: Response) => {
    try {
        ...
        // const [ userDBExists ]: TUserDB[] | undefined[] = await db("users").where({ id }) // REQUISIÇÃO PARA PEGAR USUÁRIO POR ID
        const userDatabase = new UserDatabase()
        const userDBExists : TUserDB | undefined = await userDatabase.findUsersById(id)
